...
import { DAY_NAMES, cx, fmtTime, torontoNow } from './data';
import { activeNotice, fmtYmd, setSlice, useCrown, ymdPlus, type Hours } from './store';
...
export function HoursAdmin({
  ...
  return <>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)]">
        <Panel title="Weekly hours" bodyClass="overflow-x-auto">
