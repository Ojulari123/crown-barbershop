...
import { DAY_NAMES, FAQS, SHOP, cx, fmtRange, fmtTime, torontoNow } from './data';
import { fmtYmd, setSlice, uid, useCrown, type Hours } from './store';
...
function AskForm() {
  ...
  function submit(e: FormEvent) {
    ...
    setState('sending');
    window.setTimeout(() => {
      const res = setSlice('messages', list => [{
        id: uid(),
        createdAt: Date.now(),
        name: name.trim(),
        phone: phone.trim(),
