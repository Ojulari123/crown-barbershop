...
import { SHOP, cx, fmtTime, torontoNow } from './data';
import { fmtYmd, hoursOn, isDayOff, isSlotTaken, relativeDay, setSlice, uid, useCrown, visibleServices, ymdPlus, type CrownState } from './store';
import { Calendar, type DayState } from './Calendar';
import { EASE, Heading, Ornament, Pill, Reveal } from './ui';
...
export function Booking({
  ...
  function submit(e: FormEvent) {
    ...
    setSending(true);
    window.setTimeout(() => {
      const res = setSlice('bookings', list => [...list, {
        id: uid(),
        createdAt: Date.now(),
        name: name.trim(),
        phone: phone.trim(),
